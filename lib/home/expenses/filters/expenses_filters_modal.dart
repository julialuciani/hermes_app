...
class ExpensesFiltersModal extends StatefulWidget {
  const ExpensesFiltersModal({
    super.key,
  });

  @override
  State<ExpensesFiltersModal> createState() => _ExpensesFiltersModalState();
}

class _ExpensesFiltersModalState extends State<ExpensesFiltersModal> {
  final filtersCubit = Modular.get<ExpensesScreenFiltersCubit>();
