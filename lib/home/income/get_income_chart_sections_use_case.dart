...
class GetIncomeChartSectionsUseCase {
  final MovementRepository _repository;

  GetIncomeChartSectionsUseCase(this._repository);

  Future<IncomeChartModel> call(FetchMovementsFilters filters) async {
    ...
    return IncomeChartModel(sections: sections);
  }
}
