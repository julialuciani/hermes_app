...
class GetInvestmentsUseCase {
  ...
  GetInvestmentsUseCase(this._repository);

  Future<InvestmentsModel> call(FetchMovementsFilters filters) async {
    final expenses = await _repository.fetch(filters);

    return InvestmentsModel(
      investments: _groupByPeriod(filters.periodGroup, expenses),
