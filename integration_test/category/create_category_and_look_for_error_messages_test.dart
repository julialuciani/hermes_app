...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.text('Selecione um tipo de movimentação'), findsOneWidget);
      ...
      await tester.tapAndPump(find.text('Entrada').last);
      await tester.tapAndPump(find.byKey(const Key('bnt_save_category')));
      expect(find.text('Preencha um nome para a categoria'), findsOneWidget);
      ...
      await tester.tapAndPump(find.byKey(const Key('bnt_save_category')));
      expect(find.text('Selecione um ícone'), findsOneWidget);
      await tester.tapAndPump(
